...
% Testing SVMs
accMatrix = testSvms('linear',100,models,Xtrain,Cs)
save('SVMaccMatrix_100','accMatrix');
...
% Testing SVMs
accMatrix = testSvms('linear',500,models,Xtrain,Cs)
save('SVMaccMatrix_500','accMatrix');
...
% Testing SVMs
accMatrix = testSvms('rbf',100,models,Xtrain,Cs,Gammas)
save('SVMaccMatrix_100_rbf','accMatrix');
